window.CLOUD_CATALOG = [
  { slug: 'cloudcore', name: 'CloudCore', title: '云核心', category: '基础组件', version: '2.3.0', icon: 'cloud-cog', tone: 'lime', summary: '为整个云插件系列提供统一配置、数据库、消息与跨服通信能力。', keywords: '核心 数据库 Redis 模块 热加载 状态诊断' },
  { slug: 'cloudclaim', name: 'CloudClaim', title: '云领地', category: '生存管理', version: '1.8.2', icon: 'shield-check', tone: 'blue', summary: '直观的领地保护、成员协作和精细区域规则管理。', keywords: '领地 保护 成员 权限 地图 选区' },
