  ...
  <template v-if="plugin">
    <article>
      <section class="plugin-detail-hero doc-section" id="overview">
        ...
        <div class="hero-actions"><a class="primary-button" href="#installation">开始安装 <ArrowDown /></a><a v-if="plugin.repository" class="secondary-button" :href="plugin.repository" target="_blank" rel="noreferrer"><Download />获取 v{{ plugin.version }}</a><span v-else class="secondary-button"><Download />仓库待发布</span></div>
